...
const Outils = () => {
    ...
    return (
        <div className={styles.frameOutils}>
            ...
            <button><Link to = "/creationpersonnage" onClick={scrollUp}>Création de personnage Donjons et Dragons</Link></button>
            ...
            <button><Link to = "/lanceurdes" onClick={scrollUp}>Lanceur de dès</Link></button>
        </div>
    );
};
