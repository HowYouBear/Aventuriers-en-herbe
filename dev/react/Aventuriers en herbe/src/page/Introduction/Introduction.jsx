...
import Image1 from '../../Ressources/ImageJDR1.jpg'
import Image2 from '../../Ressources/ImageJDR2.jpg'
import Image3 from '../../Ressources/ImageJDR3.jpg'
import Image4 from '../../Ressources/ImageJDR4.jpg'
import Image5 from '../../Ressources/ImageJDR5.jpg'
...
function Introduction(){
    return(
        <div className={styles.introduction}>
            ...
            <img className={styles.images} src={Image1} alt="Image de Jeu de rôle" />
            ...
            <img className={styles.images} src={Image2} alt="Image de Jeu de rôle" />
            ...
            <img className={styles.images} src={Image3} alt="Image de Jeu de rôle" />
            ...
            <img className={styles.images} src={Image4} alt="Image de Jeu de rôle" />
            ...
            <img className={styles.images} src={Image5} alt="Image de Jeu de rôle" />        
        </div>
    )
}
