    ...
    return(
        <div className={styles.frameAccueil}>
            ...
            <div className={styles.texteIntroduction}>
                ...
                <button>Aller à la page Introduction</button>
            </div>
            ...
            <div className={styles.texteUnivers}>
                ...
                <button>Aller à la page Univers</button>
            </div>
            ...
            <div className={styles.texteCreation}>
                ...
                <button>Aller à la page Création de personnage</button>
            </div>
            ...
            <div className={styles.texteLanceur}>
                ...
                <button>Aller à la page Lanceur de dés</button>
            </div>
        </div>
    )
}
